...
* Make other things "rain", like snowflakes or any other shape. If you use multiple commands to draw whatever is raining down, consider creating a custom function with x and y arguments. 
